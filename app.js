...
app.get("/", function (req, res) {
  async function find() {
    try{
      ...
      res.render("home", { homeContent: homeStartingContent, postContent: post });
    }
    catch(err) {
      console.log(err);
    }
...
app.get("/posts/:title", function (req, res) {
  ...
  async function findTitle() {
    try{
      const titleName = await Post.findOne({Title: title});
      if(titleName){
        res.render("post", { postTitle: titleName.Title, postBody: titleName.Post});
      }
      else{
